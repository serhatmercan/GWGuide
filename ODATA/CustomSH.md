# Custom Search Helps (Elementary, per-field)

Field-level search help references collected while building custom OData value helps (`ValueList` annotations / `*ValueHelpSet` entities). Source data preserved in [CustomSH.txt](CustomSH.txt).

| Field | Text Field | Selection Method | Text Table | Description (EN) | Description (TR) |
|---|---|---|---|---|---|
| Arbpl | | | CRHD | Work Center | İş Yeri |
...
| Kurst | Curvw | TCURV | TCURW | Rate Type | Kur Tipi |
| Land1 | Landx | T005 | T005T | Country / Region Key | Ülke / Bölge Anahtarı |
| Lgort | Lgobe | | T001L | Warehouse | Depo Yeri |
...
| Pltyp | Ptext | T189 | T189T | Price List | Fiyat Listesi |
| Priok | Tagen | T356 | | Priorities | Öncelikler |
...
| Tplnr | Pltxt | IFLOT | IFLOTX | Functional Location | Teknik Birim |
| Traty | Vtext | TVTY | TVTYT | Packaging Material Type | Ambalaj Malzemesi Türü |
| Vkbur | Bezei | | TVKBT | Sales Office | Satış Ofisi |
...
| Werks | Name1 | T001W | | Production Place | Üretim Yeri |
