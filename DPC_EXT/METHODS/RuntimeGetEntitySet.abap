  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~get_entityset.
    TRY.
        ...
        " Alternative - I
        IF sy-subrc = 0 AND it_order IS NOT INITIAL.
        ...
        IF sy-subrc = 0 AND it_order IS NOT INITIAL.
          ...
          LOOP AT lt_order ASSIGNING FIELD-SYMBOL(<fs_order>).
            convert_property_field( CHANGING cv_property = <fs_order>-property ).
          ENDLOOP.
      ...
      CATCH /iwbep/cx_mgw_busi_exception.
        ...
        RAISE EXCEPTION NEW /iwbep/cx_mgw_busi_exception( message_container = lo_msg_container ).
